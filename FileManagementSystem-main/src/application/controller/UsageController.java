    ...
    public void update() {
        ...
        for (int i = 0; i < Manager.DISK_BLOCK; i++) {
            ...
            switch (Manager.FAT[i]) {
                case 0:
                    cell.setStyle("-fx-border-color: #696969");
                    idle++;
                    break;
                case -2:
                    cell.setStyle("-fx-background-color: #FF4500;" +
                            "-fx-border-color: #696969");
                    down++;
                    break;
                default:
                    cell.setStyle("-fx-background-color: #00FF7F;" +
                            "-fx-border-color: #696969");
                    used++;
            }
            ((Label) ((StackPane) FATContGrid.getChildren().get(i)).getChildren().get(0))
                    .setText(String.valueOf(Manager.FAT[i]));
        }
